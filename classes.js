...
class ProgressiveManager extends Manager{
  ...
  hire(employee){
    ...
    this.reports.length < 4 ? (this.title = 'Barely Manager') :
    this.reports.length < 11 ? (this.title = 'Mostly Manager') :
    this.reports.length < 51 ? (this.title = 'Manager') :
    this.reports.length < 101 ? (this.title = 'Manager Plus') :
...
class Machine{
  ...
  makeWidgets(num){
    ...
    // for (let i = this.widgets_made_count; i > 0; i -= 50) {
    //   if(i > -1)fifties ++;
